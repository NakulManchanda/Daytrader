...
/**
 * This class holds the FTG values for each class. Currently these values are test
 * data held in a EnumMap however this class should be updated to support serialisation
 * to an XML file in the same manner as the AtrClassValue.
 * @author Roy
 */
public class FTGData {
    ...
    /**
     * Accessor to retrieve the FTG Fraction to be used in performing the FTG Test 
     ...
     */
    public Double getFTGFraction(AtrClassEnum reqClass){
        Double result = 0.0d;
        if(null != reqClass){
